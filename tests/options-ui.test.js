...
assert(optionsHtml.includes('v8.5.0 Companion'), 'workspace version label should match the current companion release');
assert.equal(manifest.version, '8.5.0', 'manifest version should match the current companion release');
