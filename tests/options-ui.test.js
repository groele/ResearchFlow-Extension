...
assert(optionsHtml.includes('v7.4.7 Companion'), 'workspace version label should match the current companion release');
assert.equal(manifest.version, '7.4.7', 'manifest version should match the current companion release');
