...
assert(optionsHtml.includes('v7.4.4 Companion'), 'workspace version label should match the current companion release');
assert.equal(manifest.version, '7.4.4', 'manifest version should match the current companion release');
...
assert(optionsJs.includes('canvasWidth = 960'), 'share images should use a compact mobile-first 960 px width');
