              ...
              <Card key={sub.id} variant="solid" padding="md" hover="lift">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex items-center gap-1">
                    <IconButton variant="ghost" size="sm" icon={<Edit2 size={13} />} aria-label={t('a11y.edit')} onClick={() => openEdit(sub)} />
                    <IconButton variant="danger" size="sm" icon={<Trash2 size={13} />} aria-label={t('a11y.delete')} onClick={() => setDeleteSubId(sub.id)} />
                  </div>
                </div>
              </Card>
            );
