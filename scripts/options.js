...
const RF_OPTIONS_RENDER_VERSION = '7.4.5';
...
const I18N = {
  en: {
    ...
    shareSizePortrait: 'Mobile portrait · adaptive 880 × 900–1350',
    shareSizeStory: 'Story · 880 × 1920',
  ...
  zh: {
    ...
    shareSizeTitle: '图片尺寸',
    shareSizePortrait: '移动竖版 · 自适应 880 × 900–1350',
    shareSizeStory: '全屏 · 880 × 1920',
    shareSizeAuto: '自适应长图',
    noEventYet: '暂无事件',
...
function createSubmissionShareCanvas(submission, visibility = {}) {
  ...
  const cardX = 30;
  const cardY = 24;
  const cardW = width - 44; // 836
  const cardH = height - 48;
  const innerX = 42;
  const innerW = width - 84; // 796
  const innerRight = innerX + innerW; // 838
